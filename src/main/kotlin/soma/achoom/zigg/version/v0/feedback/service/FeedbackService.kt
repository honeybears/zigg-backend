package soma.achoom.zigg.version.v0.feedback.service
...
import soma.achoom.zigg.version.v0.ai.dto.GenerateAIFeedbackResponseDto
import soma.achoom.zigg.version.v0.ai.service.AIService
import soma.achoom.zigg.version.v0.feedback.dto.FeedbackRequestDto
import soma.achoom.zigg.version.v0.feedback.dto.FeedbackResponseDto
import soma.achoom.zigg.version.v0.feedback.dto.FeedbackType
...
import soma.achoom.zigg.version.v0.feedback.repository.FeedbackRepository
import soma.achoom.zigg.version.v0.history.exception.HistoryNotFoundException
import soma.achoom.zigg.version.v0.history.repository.HistoryRepository
...
import soma.achoom.zigg.version.v0.space.repository.SpaceRepository
import soma.achoom.zigg.version.v0.space.repository.SpaceUserRepository
...
class FeedbackService @Autowired constructor(
    ...
    suspend fun generateAIFeedbackRequest(
        ...
        val aiFeedback = aiService.generateAIFeedbackRequest(
            soma.achoom.zigg.version.v0.ai.dto.GenerateAiFeedbackRequestDto(
